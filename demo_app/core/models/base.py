...
class Survey(models.Model):
    ...
    collection_request = models.OneToOneField(
        "django_input_collection.CollectionRequest", on_delete=models.CASCADE
    )
...
class PoliticalRally(models.Model):
    ...
    collection_requests = models.ManyToManyField(
        "django_input_collection.CollectionRequest", through="RallyPoll"
    )
