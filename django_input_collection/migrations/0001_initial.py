    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_requirement_type', models.CharField(choices=[('all-pass', 'All cases must pass'), ('one-pass', 'At least one case must pass'), ('all-fail', 'All cases must fail')], default='all-pass', max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition_group', models.ForeignKey(limit_choices_to={'parent_groups': None}, on_delete=django.db.models.deletion.CASCADE, to='django_input_collection.conditiongroup')),
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conditions', to='django_input_collection.collectioninstrument')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.CharField(max_length=512)),
                ('collection_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collectedinput_set', to='django_input_collection.collectionrequest')),
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collectedinput_set', to='django_input_collection.collectioninstrument')),
