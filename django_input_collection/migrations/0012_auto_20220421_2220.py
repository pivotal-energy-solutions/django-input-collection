...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(choices=[('all-pass', 'All cases must pass'), ('one-pass', 'At least one case must pass'), ('all-fail', 'All cases must fail')], default='all-pass', max_length=20),
        ),
