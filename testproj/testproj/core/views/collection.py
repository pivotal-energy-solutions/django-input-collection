...
class PollTemplateViewCollector(collection.RestFrameworkCollector):
    ...
    def specification(self):
        ...
        specification["instruments_info"]["ordered_instruments"] = [
            specification["instruments_info"]["instruments"][id]
            for id in specification["instruments_info"]["ordering"]
        ]
        ...
        specification["instruments_info"]["all_ordered_instruments"] = list(
            sorted(
                specification["instruments_info"]["instruments"].values(),
                key=lambda info: info["order"],
            )
        )
